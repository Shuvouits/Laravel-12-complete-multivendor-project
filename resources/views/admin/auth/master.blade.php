...
<html lang="en">
  <head>
    ...
    @include('admin.auth.section.link')
  </head>
  <body>
    ...
    <!-- BEGIN NAVBAR LOGO --><a href="{{ route('admin.login') }}" aria-label="Tabler" class="navbar-brand navbar-brand-autodark"><svg
    ...
    @include('admin.auth.section.script')
