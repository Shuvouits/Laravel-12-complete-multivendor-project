        ...
        $(function() {
            ...
            function renderTree(categories) {
                if (!categories || !categories.length) {
                    return '<ol class="dd-list" style="margin-bottom: 0"></ol>';
                }
                        ...
                        <li class="dd-item custom-cat-item" data-id="${cat.id}">
                            <div class="dd-item-row custom-cat-row">
                                ...
                                <div class="cat-label custom-cat-label" data-id="${cat.id}">
                                    ...
                                    ${
                                        cat.is_active
                                            ? '<span class="text-success ms-2" style="font-size: 10px">&#9679;</span>'
                                            : '<span class="text-danger ms-2" style="font-size: 10px">&#9679;</span>'
                                    }
                                </div>
                            </div>
                    `;
                ...
                $.post({
                    ...
                    error: function(xhr) {
                        ...
                        if (xhr.responseJSON && xhr.responseJSON.message) {
                            ...
                            notyf.error('Category order update failed.');
                        }
                    }
                });
            }
            ...
            $('#category-form').on('submit', function(e) {
                ...
                let iconInput = $('#icon')[0];
                let iconFile = iconInput && iconInput.files.length ? iconInput.files[0] : null;
                ...
                let imageFile = imageInput && imageInput.files.length ? imageInput.files[0] : null;
                        ...
                        $.ajax({
                            ...
                            error: function(xhr) {
                                ...
                                if (xhr.responseJSON && xhr.responseJSON.message) {
                                    ...
                                    notyf.error('Category delete failed.');
                                }
                            }
                        });
                    }
            ...
            function fillForm(cat) {
                ...
                $('#is_featured').prop('checked', cat.is_featured == 1);
