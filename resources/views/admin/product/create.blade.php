...
@push('styles')
    ...
    <script src="https://cdn.tiny.cloud/1/bb2fffw2ywrndm4ybdd31cqeza1jl9uq3710srm0da84ysjr/tinymce/8/tinymce.min.js" referrerpolicy="origin" crossorigin="anonymous"></script>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="short_description" id="editor1" class="ckeditor" ></textarea>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="content" id="editor2" class="ckeditor"></textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control datepicker" name="to_date" value=""
                                            id="datepicker-tow">
