                ...
                <div class="categories-dropdown-wrap style-2 font-heading mt-30">
                    <div class="d-flex categori-dropdown-inner">
                        <ul>
                            ...
                            <li>
                                <a href="#">
                                    <img src="{{ asset('frontend/assets/imgs/theme/icons/category-2.svg') }}" alt="" />
                                    Women's Clothing
                                </a>
                                <ul>
                                    <li><a href="#">Menu 01</a></li>
                            ...
                            <li>
                                <a href="#">
                                    <img src="{{ asset('frontend/assets/imgs/theme/icons/category-3.svg') }}" alt="" />
                                    Jewelry & Fashion
                                </a>
                                <ul>
                                    <li><a href="#">Menu 01</a></li>
                            ...
                            <li>
                                <a href="#">
                                    <img src="{{ asset('frontend/assets/imgs/theme/icons/category-4.svg') }}" alt="" />
                                    Sports Apparel
                                </a>
                                <ul>
                                    <li><a href="#">Menu 01</a></li>
                            ...
                            <li>
                                <a href="#">
                                    <img src="{{ asset('frontend/assets/imgs/theme/icons/category-5.svg') }}" alt="" />
                                    Skincare
                                </a>
                                <ul>
                                    <li><a href="#">Menu 01</a></li>
                            ...
                            <li>
                                <a href="#">
                                    <img src="{{ asset('frontend/assets/imgs/theme/icons/category-7.svg') }}" alt="" />
                                    Toys & Games
                                </a>
                                <ul>
                                    <li><a href="#">Menu 01</a></li>
                            ...
                            <li>
                                <a href="#">
                                    <img src="{{ asset('frontend/assets/imgs/theme/icons/category-8.svg') }}" alt="" />
                                    Sunglasses
                                </a>
                                <ul>
                                    <li><a href="#">Menu 01</a></li>
                            ...
                            <li>
                                <a href="#">
                                    <img src="{{ asset('frontend/assets/imgs/theme/icons/category-9.svg') }}" alt="" />
                                    Denim Collection
                                </a>
                                <ul>
                                    <li><a href="#">Menu 01</a></li>
                    ...
                    <div class="hero-slider-1 style-5 dot-style-1 dot-style-1-position-2">
                        <div class="single-hero-slider single-animation-wrap"
                            ...
                            <div class="slider-content">
                                ...
                                <a href="shop-grid-right.html" class="btn">Shop Now <i class="fi-rs-arrow-small-right"></i></a>
                            </div>
                        </div>
                        <div class="single-hero-slider single-animation-wrap"
