                         ...
                         <div
                             ...
                             <div class="d-flex categori-dropdown-inner">
                                 <ul>
                                     ...
                                     <li>
                                         <a href="#">
                                             <img src="{{ asset('frontend/assets/imgs/theme/icons/category-2.svg') }}"
                                                 alt="" />
                                             Women's Clothing
                                         </a>
                                         <ul>
                                     ...
                                     <li>
                                         <a href="#">
                                             <img src="{{ asset('frontend/assets/imgs/theme/icons/category-3.svg') }}"
                                                 alt="" />
                                             Jewelry & Fashion
                                         </a>
                                         <ul>
                                     ...
                                     <li>
                                         <a href="#">
                                             <img src="{{ asset('frontend/assets/imgs/theme/icons/category-4.svg') }}"
                                                 alt="" />
                                             Sports Apparel
                                         </a>
                                         <ul>
                                     ...
                                     <li>
                                         <a href="#">
                                             <img src="{{ asset('frontend/assets/imgs/theme/icons/category-5.svg') }}"
                                                 alt="" />
                                             Skincare
                                         </a>
                                         <ul>
                                     ...
                                     <li>
                                         <a href="#">
                                             <img src="{{ asset('frontend/assets/imgs/theme/icons/category-6.svg') }}"
                                                 alt="" />
                                             Exercise & Fitness
                                         </a>
                                         <ul>
                                     ...
                                     <li>
                                         <a href="#">
                                             <img src="{{ asset('frontend/assets/imgs/theme/icons/category-7.svg') }}"
                                                 alt="" />
                                             Toys & Games
                                         </a>
                                         <ul>
                                     ...
                                     <li>
                                         <a href="#">
                                             <img src="{{ asset('frontend/assets/imgs/theme/icons/category-8.svg') }}"
                                                 alt="" />
                                             Sunglasses
                                         </a>
                                         <ul>
                                     ...
                                     <li>
                                         <a href="#">
                                             <img src="{{ asset('frontend/assets/imgs/theme/icons/category-9.svg') }}"
                                                 alt="" />
                                             Denim Collection
                                         </a>
                                         <ul>
                     ...
                     <div class="header-action-2">
                         <div class="header-action-icon-2">
                             <a href="shop-wishlist.html">
                                 <img src="{{ asset('frontend/assets/imgs/theme/icons/icon-heart.svg') }}"
                                     alt="ShopX" />
                         ...
                         <div class="header-action-icon-2">
                             <a class="mini-cart-icon" href="#">
                                 <img src="{{ asset('frontend/assets/imgs/theme/icons/icon-cart.svg') }}"
                                     alt="ShopX" />
